...
function checkPwd(pwd, params) {
	...
	/* Modify overall score value based on usage vs requirements */
		...
		if (nScore > 100) { nScore = 100; } else if (nScore < 0) { nScore = 0; sVerdict = verdicts[1];}
		if (nScore >= 0 && nScore < 20) { sVerdict = verdicts[1]; }
		else if (nScore >= 20 && nScore < 40) { sVerdict = verdicts[2]; }
		else if (nScore >= 40 && nScore < 60) { sVerdict = verdicts[3]; }
		else if (nScore >= 60 && nScore < 80) { sVerdict = verdicts[4]; }
		else if (nScore >= 80 && nScore <= 100) { sVerdict = verdicts[5]; }
