 ...
 */
return [
    '{attribute} should contain at least {n, plural, one{one character} other{# characters}} ({found} found)!' => '{attribute} powinno zawierać przynajmniej {n, plural, =1{jeden znak} few{# znaki} other{# znaków}}  (wpisano {found})!',
    '{attribute} should contain at most {n, plural, one{one character} other{# characters}} ({found} found)!' => '{attribute} powinno zawierać najwyżej {n, plural, =1{jeden znak} few{# znaki} other{# znaków}}  (wpisano {found})!' ,
    '{attribute} should contain exactly {n, plural, one{one character} other{# characters}} ({found} found)!' => '{attribute} powinno zawierać dokładnie {n, plural, =1{jeden znak} few{# znaki} other{# znaków}}  (wpisano {found})!',
