...
return [
    ...
    '{attribute} should contain at least {n, plural, one{one lower case character} other{# lower case characters}} ({found} found)!' => '{attribute} deve contenere almeno {n, plural, one{un carattere minuscolo} other{# caratteri minuscoli}} ({found} trovati)!',
    '{attribute} should contain at least {n, plural, one{one numeric / digit character} other{# numeric / digit characters}} ({found} found)!' => '{attribute} deve contenere almeno {n, plural, one{un carattere numerico / cifre} other{# caratteri numerico / cifre}} ({found} trovati)!',
    '{attribute} should contain at least {n, plural, one{one special character} other{# special characters}} ({found} found)!' => '{attribute} deve contenere almeno {n, plural, one{un carattere speciale} other{# caratteri speciale}} ({found} trovati)!',
