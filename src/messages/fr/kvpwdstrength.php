...
return [
    ...
    '{attribute} should contain at least {n, plural, one{one lower case character} other{# lower case characters}} ({found} found)!' => '{attribute} {n, plural, one{devrait contenir au moins un caractère en minuscule} other{# doit contenir au moins caractères minuscules}}! ({found} trouvé)!',
    '{attribute} should contain at least {n, plural, one{one numeric / digit character} other{# numeric / digit characters}} ({found} found)!' => '{attribute} {n, plural, one{devrait contenir au moins un caractère numérique / chiffres} other{# doit contenir au moins caractères numérique / chiffres}}! ({found} trouvé)!',
    ...
    '{attribute} should contain at least {n, plural, one{one upper case character} other{# upper case characters}} ({found} found)!' => '{attribute} {n, plural, one{devrait contenir au moins une lettre majuscule} other{# doit contenir au moins caractères majuscules}}! ({found} trouvé)!',
