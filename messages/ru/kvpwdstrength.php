...
return [
    '{attribute} should contain at least {n, plural, one{one character} other{# characters}} ({found} found)!' =>
        '{attribute} должен содержать {n, plural, =1{хотя бы один символ} one{минимум # символ} few{минимум # символа} many{минимум # символов}} ({found} найдено)!',
    ...
    '{attribute} should contain exactly {n, plural, one{one character} other{# characters}} ({found} found)!' =>
        '{attribute} должен содержать ровно {n, plural, one{# символ} few{# символа} many{# символов}} ({found} найдено)!',
    ...
    '{attribute} should contain at least {n, plural, one{one lower case character} other{# lower case characters}} ({found} found)!' =>
        '{attribute} должен содержать минимум {n, plural, one{# строчный символ} few{# строчных символа} many{# строчных символов}} ({found} найдено)!',
    '{attribute} should contain at least {n, plural, one{one upper case character} other{# upper case characters}} ({found} found)!' =>
        '{attribute} должен содержать минимум {n, plural, one{# символ верхнего регистра} few{# символа верхнего регистра} many{# символов верхнего регистра}} ({found} найдено)!',
    '{attribute} should contain at least {n, plural, one{one numeric / digit character} other{# numeric / digit characters}} ({found} found)!' =>
            '{attribute} должен содержать минимум {n, plural, one{# цифру} few{# цыфры} many{# цифер}} ({found} найдено)!',
    '{attribute} should contain at least {n, plural, one{one special character} other{# special characters}} ({found} found)!' =>
        '{attribute} должен содержать минимум {n, plural, one{# специальный символ} few{# специальных символа} many{# специальных символов}} ({found} найдено)!'
];
